...
export default function AccountingPage() {
  ...
  const totals = useMemo(() => {
    ...
    const ar=entries.filter(e=>e.type==="invoice"&&e.status!=="paid").reduce((s,e)=>s+e.amount,0);
    const ap=entries.filter(e=>e.type==="bill"&&e.status!=="paid").reduce((s,e)=>s+e.amount,0);
